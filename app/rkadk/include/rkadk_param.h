...
#define AI_DEPTH 1
#if defined(RV1106_1103) || defined(RV1103B) || defined(RV1126B) || defined(RK3506)
...
typedef enum {
  ...
  RKADK_PARAM_TYPE_MUTE,            /* mute specifies sensor, bool */
...
typedef struct tagRKADK_PARAM_VI_CFG_S {
  RKADK_U32 chn_id;  /* chn 2 -> scale1, chn 3 -> scale0 for rv1126b vpss online */
  char device_name[MAX_VI_ENTITY_NAME_LEN];
  RKADK_U32 buf_cnt;
  RKADK_U32 width;
  RKADK_U32 height;
  RKADK_U32 depth;
  char pix_fmt[RKADK_PIX_FMT_LEN]; /* options: NV12/NV16/YUYV/FBC0/FBC2/RKFBC0/RKFBC2 */
