...
typedef struct {
  ...
  RKADK_PLAYER_FADEIN_CFG_S stFadeInCfg;
} RKADK_PLAYER_CFG_S;
...
/**
 * @brief set vo fade in frames
 * @param[in] pPlayer : RKADK_MW_PTR: handle of the player
 * @param[in] u32FadeInFrames : vo u32FadeInFrames
 * @retval  0 success, others failed
 */
RKADK_S32 RKADK_PLAYER_SetFadeInFrames(RKADK_MW_PTR pPlayer, RKADK_U32 u32FadeInFrames);

/**
 * @brief set smooth loop enable
 * @param[in] pPlayer : RKADK_MW_PTR: handle of the player
 * @retval  0 success, others failed
 */
