...
static void SetVersion() {
  ...
  RKADK_Struct2Ini(-1, RKADK_PARAM_PATH, &stParamVersion, g_stVersionMapTable,
                   sizeof(g_stVersionMapTable) / sizeof(RKADK_SI_CONFIG_MAP_S));
}
...
static void SetCommCfg() {
  ...
  RKADK_Struct2Ini(-1, RKADK_PARAM_PATH, &stParamCommCfg, g_stCommCfgMapTable,
...
static void SetAudioCfg() {
  ...
  RKADK_Struct2Ini(-1, RKADK_PARAM_PATH, &stAudioCfg, g_stAudioCfgMapTable,
...
static void SetRecCfg() {
  ...
  RKADK_Struct2Ini(0, sensorPath, &stParamRecCfg, g_stRecCfgMapTable,
                   sizeof(g_stRecCfgMapTable) / sizeof(RKADK_SI_CONFIG_MAP_S));
  RKADK_Struct2Ini(0, sensorPath, &stParamRecCfg.attribute[0], g_stRecCfgMapTable_0,
      sizeof(g_stRecCfgMapTable_0) / sizeof(RKADK_SI_CONFIG_MAP_S));
  RKADK_Struct2Ini(0, sensorPath, &stParamRecCfg.attribute[1], g_stRecCfgMapTable_1,
      sizeof(g_stRecCfgMapTable_1) / sizeof(RKADK_SI_CONFIG_MAP_S));
  RKADK_Struct2Ini(0, sensorPath, &stParamRecCfg.record_time_cfg[0], g_stRecTimeCfgMapTable_0,
      sizeof(g_stRecTimeCfgMapTable_0) / sizeof(RKADK_SI_CONFIG_MAP_S));
  RKADK_Struct2Ini(0, sensorPath, &stParamRecCfg.record_time_cfg[1], g_stRecTimeCfgMapTable_1,
...
static void SetStreamCfg() {
  ...
  RKADK_Struct2Ini(0, sensorPath, &stStreamCfg, g_stPreviewCfgMapTable,
...
static void SetLiveCfg() {
  ...
  RKADK_Struct2Ini(0, sensorPath, &stLiveCfg, g_stLiveCfgMapTable,
...
static void SetPhotoCfg() {
  ...
  RKADK_Struct2Ini(0, sensorPath, &stPhotoCfg, g_stPhotoCfgMapTable,
...
static void SetViCfg() {
  ...
  RKADK_Struct2Ini(0, sensorPath, &stViCfg, g_stViCfgMapTable_0,
  ...
  RKADK_Struct2Ini(0, sensorPath, &stViCfg, g_stViCfgMapTable_1,
  ...
  RKADK_Struct2Ini(0, sensorPath, &stViCfg, g_stViCfgMapTable_2,
  ...
  RKADK_Struct2Ini(0, sensorPath, &stViCfg, g_stViCfgMapTable_3,
...
static void SetDispCfg() {
  ...
  stDispCfg.vo_chn = 0;
  RKADK_Struct2Ini(0, sensorPath, &stDispCfg, g_stDispCfgMapTable,
...
static void SetThumbCfg() {
  ...
  RKADK_Struct2Ini(0, sensorPath, &stThumbCfg, g_stThumbCfgMapTable,
